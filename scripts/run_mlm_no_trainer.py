...
def parse_args():
    ...
    parser.add_argument(
        "--warmup_ratio", type=float, default=0.0, help="Number of steps for the warmup in the lr scheduler."
    )
...
def main():
    ...
    if args.warmup_ratio:
        args.num_warmup_steps = int(args.warmup_ratio * len(train_dataloader))
