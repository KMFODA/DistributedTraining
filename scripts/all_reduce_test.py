...
def perform_all_reduce(custom_group: GroupInfo, models, dht_instances: List[DHT]):
    ...
    dummy_input = torch.randn(1, 37)  # Adjust the size according to your model's input size
    dummy_target = torch.randn(1, 1)  # Adjust the size according to your model's output size
